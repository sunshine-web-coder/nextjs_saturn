...
export function CountriesSelectForm() {
  const {
    control,
    handleSubmit,
    formState: { errors },
...
export function PhoneNumberForm() {
  ...
  const onSubmit = (data) => {
    ...
    // Proceed to the next step
    router.push("/signup/email_password");
  };
      ...
      <div className="mb-2">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mt-10 flex items-center justify-between gap-5">
            <Button
              type="button"
              onClick={() => router.back()} // Navigate back to the previous route
...
export function PhoneNumberConfirmationForm() {
  ...
  return (
    <div>
      ...
      <div className="mt-10 flex items-center justify-between gap-5">
        <Button className="h-12 max-w-max rounded-lg bg-[#00A9A4] text-lg font-semibold text-white">
          Previous
        </Button>
        <Button className="h-12 max-w-max rounded-lg bg-[#00A9A4] text-lg font-semibold text-white">
          Next
...
export function EmailNamePasswordForm() {
  const {
    control,
    handleSubmit,
    formState: { errors },
  ...
  const onSubmit = (data) => {
    ...
    // Proceed to the next step
    router.push("/signup/user_address");
  };
...
export function UserAddressForm() {
  ...
  const onSubmit = (data) => {
    ...
    // Proceed to the next step
    router.push("/signup/confirmation_page");
  };
  return (
    <div className="">
      <div className="mb-8 text-center text-3xl font-semibold text-[#001435]">
  ...
  return (
    <div>
      ...
      <div>
        ...
        <p>Selected Country: {userData.selectedCountry}</p>
        <p>Phone Number: {userData.phoneNumber}</p>
        <p>Address: {userData.addressLine1}</p>
        <p>City: {userData.city}</p>
        <p>Postal Code: {userData.postalCode}</p>
        <p>State/Capital: {userData.state}</p>
      </div>
